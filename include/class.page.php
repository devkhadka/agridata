    ...
    function getContent() {
        ...
        switch ($this->request) {
            ...
            case "list_products_info": require_once('./pages/list_products_info.php');
                ...
                break;
            case "addvisitplan": require_once('./pages/visitplan.php');
                self::$content = addVisitplan();
                break;
            case "editvisitplan": require_once('./pages/visitplan.php');
                self::$content = editVisitplan();
                break;
            case "viewvisitplan": require_once('./pages/visitplan.php');
                viewVisitplan();
                break;
            case "mviewvisitplan": require_once('./pages/visitplan.php');
                mviewVisitplan();
                break;
            case "addcollectionplan": require_once ('./pages/collectionplan.php');
                self::$content = addCollectionPlan();
                break;
            case "viewcollectionplan": require_once ('./pages/collectionplan.php');
                viewCollectionPlan();
                break;
            case "editcollectionplan": require_once ('./pages/collectionplan.php');
                self::$content = editCollectionPlan();
                break;
            case "mviewcollectionplan": require_once ('./pages/collectionplan.php');
                mViewCollectionPlan();
                break;
            case "addsalesplan": require_once ('./pages/salesplan.php');
                self::$content = addSalesPlan();
                break;
            case "viewsalesplan": require_once ('./pages/salesplan.php');
                viewSalesPlan();
                break;
            case "editsalesPlan": require_once ('./pages/salesplan.php');
                self::$content = editSalesPlan();
                break;
            case "viewsalesplandetail": require_once ('./pages/salesplan.php');
                viewSalesPlanDetail();
                break;
            case "mviewsalesplan": require_once ('./pages/salesplan.php');
                mViewSalesPlan();
                break;
            case "adddueamount": require_once ('./pages/dueamount.php');
                self::$content = addDueAmount();
                break;
            case "viewdueamount": require_once ('./pages/dueamount.php');
                viewDueAmount();
                break;
            case "editdueamount": require_once ('./pages/dueamount.php');
                self::$content = editDueAmount();
                break;
            default:
                require_once './pages/dashboard.php';
                self::$content = getDashboard();
