			...
			<div id = "students">
				<table border=0 align='left' width ='70%'>				
					...
					<tr>					
						...
						<td width='8'></td>
						<td width='200'><textarea name="questionS" ></textarea></td>					
                                                <td> </td>
					</tr>
				</table>			
			</div>		
			<div id = "farmer">
				<table border=0 align='left' width ='70%'>				
					...
					<tr>					
						...
						<td width='8'></td>
						<td width='200'><textarea name="generalF" ></textarea></td>					
                                                <td> </td>
					</tr>
					<tr>					
						<td width='200' align='right'>Problems in Crop(Specific) :</td>
						<td width='8'></td>
						<td width='200'><textarea name="specificF" ></textarea></td>					
                                                <td> </td>
					</tr>
					<tr>					
			...
			<div id = "research">
				<table border=0 align='left' width ='70%'>				
					...
					<tr>					
						...
						<td width='8'></td>
						<td width='200'><textarea name="explanationR" ></textarea></td>					
                                                <td> </td>
					</tr>					
				</table>			
			</div>
