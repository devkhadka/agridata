...
function getUserMenu(){
    ...
    if($user->logged_in && $user->level>0){
        ...
        $ret.="<li class='newbullet'><a href='?page=adddcr'>Add DCR</a></li>
            ...
            <li class='newbullet'><a href='?page=viewpartystock'>View Party Stock</a></li><br />";
        }
        if($user->level==MMR_LEVEL || $user->level==ADMIN_LEVEL){
            $ret.="<li class='newbullet'><a href='?page=mviewdcr'>Mgr. View DCR</a></li>
            <li class='newbullet'><a href='?page=mviewtada'>Mgr. View TA/DA</a></li>
            <li class='newbullet'><a href='?page=mviewpartystock'>Mgr. View Party Stock</a></li><br />";
        }
	   ...
	   */
        ...
        if($user->isAdmin()){
            $ret.="Admin Tasks<br /><li class='newbullet'><a href='?page=addnews'>Add News</a></li>"
				...
				."<li class='newbullet'><a href='?page=viewtasetting'>View TA Setting</a></li><br/>";
...
function getGreetings(){
    global $user;
    $ret= "<div id='greeting' >Welcome &nbsp;<b>$user->username </b> ! <a href=\"process.php\">Logout</a>
