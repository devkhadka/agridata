...
--
-- Host: localhost
-- Generation Time: Nov 13, 2011 at 11:11 AM
...
(1, '2011-07-25', '2011-07-30', 1, '5000.00', '2011-07-25', 3),
(2, '2011-08-01', '2011-08-15', 1, '2000.00', '2011-07-25', 3),
...
--
-- Table structure for table `syn_current_due`
--

-- CREATE ALGORITHM=UNDEFINED DEFINER=`agricare`@`localhost` SQL SECURITY DEFINER VIEW `agricare_nepal`.`syn_current_due` AS select `agricare_nepal`.`syn_party_due`.`id` AS `id`,`agricare_nepal`.`syn_party_due`.`collected_date` AS `collected_date`,`agricare_nepal`.`syn_party_due`.`amount` AS `amount`,`agricare_nepal`.`syn_party_due`.`party_id` AS `party_id`,`agricare_nepal`.`syn_party_due`.`created_by` AS `created_by`,`agricare_nepal`.`syn_profile`.`name` AS `party_name` from ((`agricare_nepal`.`syn_party_due` join `agricare_nepal`.`syn_party` on((`agricare_nepal`.`syn_party_due`.`party_id` = `agricare_nepal`.`syn_party`.`id`))) join `agricare_nepal`.`syn_profile` on((`agricare_nepal`.`syn_profile`.`id` = `agricare_nepal`.`syn_party`.`profile_id`))) order by `agricare_nepal`.`syn_party_due`.`collected_date` desc;

--
-- Dumping data for table `syn_current_due`
--

-- INSERT INTO `syn_current_due` (`id`, `collected_date`, `amount`, `party_id`, `created_by`, `party_name`) VALUES
-- (6, '2011-11-10 00:00:00', '100.00', 10, 1, 'Chitwan Agro Pharma'),
-- (5, '2011-11-08 00:00:00', '12.00', 10, 1, 'Chitwan Agro Pharma'),
-- (7, '2011-11-08 00:00:00', '1000.00', 9, 1, 'Sagarmatha Agrovet'),
-- (3, '2011-07-28 00:00:00', '15000.00', 3, 1, 'bidari agrovet'),
-- (4, '2011-07-15 00:00:00', '10000.00', 10, 1, 'Chitwan Agro Pharma'),
-- (2, '2011-07-06 00:00:00', '10000.00', 10, 1, 'Chitwan Agro Pharma');
...
(1, '2011-07-25', 'test customer', 1, 'test remarks', 3, '2011-07-25', 0, '0000-00-00 00:00:00', 0),
(2, '2068-04-01', 'Mechi agro birtamod', 4, 'Our distributor visit', 9, '2011-07-27', 0, '0000-00-00 00:00:00', 0),
(3, '2068-04-11', 'Jansewa Agrmvet, Amul Agrovet, Sindhu Agrovet, Pramila agrovet ', 4, 'Ngt.- Parsa Khairahani Retailer visit', 8, '2011-07-27', 0, '0000-00-00 00:00:00', 0),
(4, '2011-07-27', 'Jansewa Agrmvet, Amul Agrovet, Sindhu Agrovet, Pramila agrovet ', 4, 'Ngt.- Parsa Khairahani Retailer visit', 8, '2011-07-27', 0, '0000-00-00 00:00:00', 0),
(7, '2011-07-31', 'Chumaganesh agro center,bhaktapur. Bhaktapur beej bhandar,bhaktapur. ', 4, 'Aaja chumaganesh agro center bata stock linuko sathai ramro order pani liyeko chu. So order maile officema pani bhani sake. Pani parekole club rootko sample use garna pako chaina.', 5, '2011-07-31', 0, '0000-00-00 00:00:00', 0),
(8, '2011-08-01', 'Harabhara agro vet, pokhara. Janasewa krisi bhandar, pokhara. Nepal krisi bhandar, pokhara. Unnati a', 4, 'Harabhara agro saga business ko kura bhayo agriguard projectle khojdai cha yo barsa business badcha bhanne kura bhako cha.', 5, '2011-08-01', 0, '0000-00-00 00:00:00', 0),
(9, '2011-08-05', 'asee', 1, 'good', 5, '2011-08-11', 0, '0000-00-00 00:00:00', 0),
(10, '2011-08-04', 'dinesh', 2, 'very good', 5, '2011-08-11', 0, '0000-00-00 00:00:00', 0),
(11, '2011-08-15', 'Suresh', 2, 'Very useful person', 5, '2011-08-15', 0, '0000-00-00 00:00:00', 0),
(12, '2011-08-18', 'Pooja Agrovet. Shiva Agrovet. Palung Beej Bhandar. Samudayik Krishi pasal. Niraj Pradhan. Pudasaini ', 4, 'Palung via Htd. to Ngt visit', 8, '2011-08-18', 0, '0000-00-00 00:00:00', 0),
(15, '2011-08-19', 'Dawadi Agro Concern, Kisan Agro Traders, Chitwan agro pharma, Jansewa Agrovet, Prashant Agro', 4, 'Dawadi,Ctn. Agro, Kisan Agro discussion about payement.', 8, '2011-08-19', 0, '0000-00-00 00:00:00', 0),
(16, '2011-08-20', 'Saturday', 4, 'Saturday', 8, '2011-08-20', 0, '0000-00-00 00:00:00', 0),
(17, '2011-08-18', 'Chumaganesh agro, bhaktapur. Harc, kalimati. New everest agro,kalimati. National agro, lagankhel.', 4, 'Chumaganesh agro bata 100000 rs aayo.', 5, '2011-08-20', 0, '0000-00-00 00:00:00', 0),
(18, '2011-08-19', 'Chumaganesh agro center,bhaktapur. Gramid agro,dolalghat. Sambhu parajuli,kuntabesi. Jugal agro vet,', 4, 'Sabai partylai prise badeko jankari garaye.', 5, '2011-08-20', 0, '0000-00-00 00:00:00', 0),
(19, '2011-08-21', 'Dawadi agrovet, Maadi agrovet, ctn.vet,maadi, paudel agrovet, bhurtel agrovet, machhapuchchhre co. L', 4, 'Ngt-Maadi', 8, '2011-08-21', 0, '0000-00-00 00:00:00', 0),
(20, '2011-08-22', 'Bhurtel agrovet, chapagain agrovet, poudel agrovet, kisan agrovet, hi-himal seed.', 2, 'Maadi, Jagatpur, Ngt.', 8, '2011-08-23', 0, '0000-00-00 00:00:00', 0),
(21, '2011-08-23', 'Bishal vet, Kisan agro, Dawadi agro, Milijuli agro, Sharma agro, Bhandari agro, Neupane agro, Aachal', 2, 'Ngt., Chanouli, Meghauli ', 8, '2011-08-23', 0, '0000-00-00 00:00:00', 0),
(22, '2011-08-24', 'Sajha agrovet, Aryal agro supp. Jyamire krishi, Sindhu agrovet, Jansewa agrovet, Kisan agrovet, Laxm', 2, 'Ngt.-Bhandara', 8, '2011-08-24', 0, '0000-00-00 00:00:00', 0),
(23, '2011-08-30', 'Saanu', 2, 'Excellent', 5, '2011-08-27', 0, '0000-00-00 00:00:00', 0),
(24, '2011-08-02', 'asee', 3, 'nice\r\n', 5, '2011-08-28', 0, '0000-00-00 00:00:00', 0),
(25, '2011-08-03', 'asee', 4, 'niceeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', 5, '2011-08-29', 0, '0000-00-00 00:00:00', 0),
(26, '2011-10-19', 'asee', 1, 'nice', 4, '2011-10-18', 0, '0000-00-00 00:00:00', 0),
(27, '2011-10-15', 'naanu', 1, 'nice very nice', 4, '2011-10-18', 0, '0000-00-00 00:00:00', 0),
(28, '2011-11-08', 'asee', 2, 'Very good\r\n', 5, '2011-11-03', 0, '0000-00-00 00:00:00', 0);
...
(64, 65, '75', '2010-01-01', 1),
(65, 5, '75.90', '2011-07-17', 0),
(66, 15, '100', '2011-01-15', 0),
(67, 30, '120', '2011-01-01', 0),
...
(1, '2011-07-25', 1, 56, 10, 1, 3, '2011-07-25'),
(2, '2011-07-25', 1, 55, 5, 2, 3, '2011-07-25'),
...
INSERT INTO `syn_party_due` (`id`, `collected_date`, `amount`, `party_id`, `created_at`, `created_by`) VALUES
(1, '2011-07-24 00:00:00', '10000.00', 1, '2011-07-25 00:00:00', 1),
(2, '2011-07-06 00:00:00', '10000.00', 10, '2011-07-31 00:00:00', 1),
(3, '2011-07-28 00:00:00', '15000.00', 3, '2011-07-31 00:00:00', 1),
(4, '2011-07-15 00:00:00', '10000.00', 10, '2011-07-31 00:00:00', 1),
(5, '2011-11-08 00:00:00', '12.00', 10, '2011-11-07 00:00:00', 1),
(6, '2011-11-10 00:00:00', '100.00', 10, '2011-11-08 00:00:00', 1),
(7, '2011-11-08 00:00:00', '1000.00', 9, '2011-11-09 00:00:00', 1);
...
(1, '2011-07-25', '2011-07-30', 1, '2011-07-25', 3),
(2, '2011-07-24', '2011-07-29', 3, '2011-07-28', 5),
(3, '2011-07-05', '2011-09-30', 11, '2011-07-30', 8),
(4, '2011-07-20', '2011-07-31', 3, '2011-07-30', 5),
(5, '2011-07-20', '2011-07-31', 2, '2011-07-30', 5),
(6, '2011-08-04', '2011-08-18', 2, '2011-08-28', 5),
(7, '2011-10-16', '2011-10-20', 2, '2011-10-18', 5),
(8, '2011-10-04', '2011-10-27', 7, '2011-10-20', 4),
...
(1, '2011-07-25', 'pokhara', '50', '500', '200', 'test tada remarks', 3, '2011-07-25', 0, '0000-00-00 00:00:00', 0),
(2, '2011-07-27', 'bhaktapur', '75', '250', '60', ' 60 rupee ko ompssion di ya ko yeuta keta lai \r\n', 5, '2011-07-27', 0, '0000-00-00 00:00:00', 0),
(3, '2068-07-27', 'Ngt.Parsa,khairahani ', '80 ', '200', '', 'Retailer visit', 8, '2011-07-27', 0, '0000-00-00 00:00:00', 0),
(4, '2011-07-31', 'Kalimati to Bhaktapur', '60 ', '200', '1', 'Nothing', 5, '2011-07-31', 0, '0000-00-00 00:00:00', 0),
(5, '2011-08-01', 'Kathmandu to pokhara', '200', '500', '100', 'Nothing', 5, '2011-08-01', 0, '0000-00-00 00:00:00', 0),
(6, '2068-05-01', 'Palung, Hetaunda', '160 ', '250', '', 'Palung, Htd. Ngt.', 8, '2011-08-18', 0, '0000-00-00 00:00:00', 0),
(7, '2011-08-18', 'Palung, Hetaunda', '160 ', '250', '', 'Palung, Htd, Ngt', 8, '2011-08-19', 0, '0000-00-00 00:00:00', 0),
(8, '2011-08-18', 'Kathmandu, bhaktapur, lagankhel', '70', '250', '1', 'Nothing', 5, '2011-08-20', 0, '0000-00-00 00:00:00', 0),
(9, '2011-08-19', 'Bhaktapur,dolalghat,kuntabesi,dhulikhel,panauti,nala.', '180', '250', '1', 'Nothing', 5, '2011-08-20', 0, '0000-00-00 00:00:00', 0),
(10, '2011-08-19', 'Ngt., Tandi, Khurkhure', '70', '250', '00', 'Ngt', 8, '2011-08-20', 0, '0000-00-00 00:00:00', 0),
(11, '2011-08-21', 'Ngt,jagatpur,Maadi', '85', '700', '', 'Ngt,jagatpur,Maadi', 8, '2011-08-21', 0, '0000-00-00 00:00:00', 0),
(12, '2011-08-22', 'Maadi, Jagatpur, Ngt', '85', '250', '', 'Maadi-Ngt.', 8, '2011-08-23', 0, '0000-00-00 00:00:00', 0),
(13, '2011-08-23', 'Ngt., Chanouli, Meghauli', '70', '250', '', 'Ngt., Meghauli', 8, '2011-08-23', 0, '0000-00-00 00:00:00', 0),
(14, '2011-08-24', 'Ngt., Parsa, Bhandara', '80', '250', '00', 'Ngt.-Bhandara', 8, '2011-08-24', 0, '0000-00-00 00:00:00', 0),
(15, '2011-08-15', 'Nepalgunjuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu', '15', '3000', '400', 'Very Good.', 5, '2011-08-28', 0, '0000-00-00 00:00:00', 0),
(16, '2011-10-16', 'Tamakoshi', '8', '10', '19', 'Very good', 5, '2011-10-18', 0, '0000-00-00 00:00:00', 0),
(19, '2011-10-26', 'nepal', '5', '7', '7', 'good', 5, '2011-10-23', 0, '0000-00-00 00:00:00', 0),
(20, '2011-10-25', 'myanmar', '6', '45', '7', 'nice', 5, '2011-10-23', 0, '0000-00-00 00:00:00', 0),
(21, '2011-10-20', 'nepal', '6', '6', '7', 'nice', 5, '2011-10-23', 0, '0000-00-00 00:00:00', 0),
(22, '2011-11-02', 'palpa', '5', '45', '3', 'good', 5, '2011-11-03', 0, '0000-00-00 00:00:00', 0),
(23, '2011-11-02', 'nepal', '5', '6', '3', 'good', 4, '2011-11-03', 0, '0000-00-00 00:00:00', 0),
(24, '2011-10-05', 'nepal', '5', '6', '6', 'goood', 4, '2011-11-03', 0, '0000-00-00 00:00:00', 0),
(25, '2011-11-03', 'nepal', '7', '7', '7', 'nice', 4, '2011-11-03', 0, '0000-00-00 00:00:00', 0),
(26, '2011-11-04', 'nepal', '7', '7', '7', 'nice', 4, '2011-11-03', 0, '0000-00-00 00:00:00', 0),
(27, '2011-11-01', 'Birgunj', '4', '3', '8', 'good', 4, '2011-11-03', 0, '0000-00-00 00:00:00', 0),
(28, '2011-11-07', 'Birgunj', '7', '6', '56', 'good', 4, '2011-11-03', 0, '0000-00-00 00:00:00', 0);
...
(1, 'admin', '2aefc34200a294a3cc7db81b43a81873', 9, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(10, 'asee', '845ea8e40c18cb139d843f5125a3a86f', 2, 29, 4, '2011-07-28 02:59:33', '0000-00-00 00:00:00'),
(4, 'raaj', 'fd66a4f14f46a2af3ea6bc3a691895ac', 4, 4, 0, '2011-07-26 01:30:54', '0000-00-00 00:00:00'),
(5, 'bivek', '539971fbf9c079394cf17532412825a3', 2, 5, 8, '2011-07-26 02:03:08', '0000-00-00 00:00:00'),
(7, 'basanta', '5fffc649f786af4404538dda21a1708d', 2, 7, 4, '2011-07-26 02:30:14', '0000-00-00 00:00:00'),
(8, 'dinesh', 'fd66a4f14f46a2af3ea6bc3a691895ac', 4, 8, 4, '2011-07-26 02:38:43', '0000-00-00 00:00:00'),
...
(1, 3, '2011-07-30', 'biratnagar', '', 'test visit plan remarks', '2011-07-25 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(2, 5, '2011-07-15', 'heutanda', '', 'helllo sir for the collection ', '2011-07-28 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(3, 5, '2011-08-20', 'Kathmanduuuuuuuuuuuuuuuuuuuu', '', 'Very Goodaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', '2011-08-28 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(4, 5, '2011-10-17', 'Hetauda', '', 'Good', '2011-10-18 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(5, 4, '2011-10-17', 'nepal', '', 'nice', '2011-10-18 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(6, 8, '2011-10-19', 'nepal', '', 'good', '2011-10-18 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(7, 5, '2011-10-20', 'NEPAL', '', 'GOOD', '2011-10-21 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(8, 5, '2011-10-13', 'narayanghat', '', 'nice', '2011-10-21 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(9, 5, '2011-10-21', 'palpa', '', 'nice', '2011-10-21 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(42, 5, '2011-10-10', 'nepalgunj', '', 'hello', '2011-10-23 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(14, 5, '2011-10-11', 'catmadnu', '', 'good\r\n', '2011-10-22 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(21, 5, '2011-10-08', 'nepal', '', 'document', '2011-10-22 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(20, 5, '2011-10-07', 'catmadnu', '', 'sample test', '2011-10-22 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(37, 5, '2011-10-26', 'nepal', '', 'good', '2011-10-23 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(36, 5, '2011-10-27', 'nepalgunj', '', 'nice', '2011-10-23 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(35, 5, '2011-10-28', 'nepalgunj', '', 'nice', '2011-10-23 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(34, 5, '2011-10-12', 'nepalgunj', '', 'goood', '2011-10-23 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(33, 5, '2011-10-19', 'nepal', '', 'good', '2011-10-23 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(38, 5, '2011-10-31', 'nepalgunj', '', 'nice', '2011-10-23 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(39, 5, '2011-10-25', 'nepalgunj', '', 'ncie', '2011-10-23 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(40, 5, '2011-10-24', 'nepalgunj', '', 'dfd', '2011-10-23 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(41, 5, '2011-10-15', 'nepalgunj', '', 'nice', '2011-10-23 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0);
