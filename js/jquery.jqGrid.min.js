...
$(grid.bDiv).append($('<div style="position:relative;>'+(isMSIE&&$.browser.version<8?"height:0.01%;":"")+'"</div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({
...
b(R.p.colModel).each(function(af){
    ...
    var ae=b.extend({},this.editoptions||{},{
        id:H,
        name:H
    }),aj=b.extend({},{
        rowabove:false,
        rowcontent:""
    },this.formoptions||{}),ag=parseInt(aj.rowpos)||V+1,ai=parseInt((parseInt(aj.colpos)||1)*2);
    if(aj.rowabove){
    ...
    a.jgrid.extend({
        editCell:function(d,c,b){
            ...
            k=a("td:eq("+c+")",l.rows[d]);
                ...
                var g=a.extend({},l.p.colModel[c].editoptions||{},{
                id:d+"_"+e,
                name:e
            });
